...
export const command = {
    ...
    ,helpman: {
        ...
        ,goleadores: '📑 !goleadores [semana|mes|global] : Muestra el top de goleadores. Sin parámetro muestra el top del día; usa sufijos semana, mes o global para otros períodos.'
        ,asistidores: '📑 !asistidores [semana|mes|global] : Muestra el top de asistidores. Sin parámetro muestra el top del día; usa sufijos semana, mes o global para otros períodos.'
